shared_examples 'type_de_champ_spec' do
  ...
  describe 'field_for_list?' do
    let(:type_de_champ_yes) { create :type_de_champ, type_champ: 'text' }
    let(:type_de_champ_no_1) { create :type_de_champ, type_champ: 'textarea' }
    let(:type_de_champ_no_2) { create :type_de_champ, type_champ: 'header_section' }
