...
ActiveRecord::Schema.define(version: 20170522204912) do
  ...
  create_table "unreads", force: :cascade do |t|
    ...
    t.integer "dossier_id"
    t.index ["dossier_id"], name: "index_unreads_on_dossier_id", using: :btree
    t.index ["gestionnaire_id"], name: "index_unreads_on_gestionnaire_id", using: :btree
    t.index ["notification_id"], name: "index_unreads_on_notification_id", using: :btree
  end
